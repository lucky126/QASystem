...
namespace ChinaHCM.QA.Component.Data
{
    ...
    public abstract class EFRepositoryBase<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        /// <returns></returns>
        public virtual IEnumerable<TEntity> RowSqlQuery(string sql, params object[] parameters)
        {            
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public virtual IEnumerable<TEntity> DBSqlQuery(string sql, params object[] parameters)
        {
            return EFContext.DbContext.Database.SqlQuery<TEntity>(sql, parameters);
        }
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public virtual int DBSqlCommand(string sql, params object[] parameters)
        {
            return EFContext.DbContext.Database.ExecuteSqlCommand(sql, parameters);
        }
