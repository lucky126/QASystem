...
namespace ChinaHCM.QA.Component.Data
{
    ...
    public interface IRepository<TEntity> where TEntity : class
    {
        ...
        /// <returns></returns>
        IEnumerable<TEntity> RowSqlQuery(string sql, params object[] parameters);
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        IEnumerable<TEntity> DBSqlQuery(string sql, params object[] parameters);
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        int DBSqlCommand(string sql, params object[] parameters);
